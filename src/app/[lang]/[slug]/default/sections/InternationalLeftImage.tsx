...
interface InternationalLeftImageProps {
    section: PageSection
}

export default function InternationalLeftImage({ section }: InternationalLeftImageProps) {
    const block = section.block
    const list = section.list || []
    if (!block) return null

    const mainTitle = block.c_1 // "Why Choose Muscat University"
    ...
    return (
        <section id="why-choose" className="pt-18 pb-9">
            ...
            {/* Separator Line included in static layout often after sections */}
