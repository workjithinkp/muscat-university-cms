...
import { gsap } from 'gsap' // ← This was missing
import { ScrollTrigger } from 'gsap/ScrollTrigger' // ← This too
        ...
        <div className="container mx-auto">
          ...
          <div className="relative mx-auto w-full max-w-[1000px]">
            ...
            <div className="absolute inset-0">
              <div className="absolute top-0 right-[40%] w-[750px]">
                <ul className="flex flex-col gap-2 text-end">
                  <li className="font-medium">
                    Research Commercialization & Intellectual Property
                  </li>
                  <li className="me-[100px] font-medium">
                    Societal, Environmental & Economic Impact
                  </li>
                  <li className="me-[200px] font-medium">
                    Disseminate Knowledge & Research Results
                  </li>
                  <li className="me-[300px] font-medium">
                    Ensure Sustainable Research Activities & <br />
                    Infrastructure Development
                  </li>
                </ul>
              </div>
              <div className="absolute top-[250px] left-[10%] w-[750px]">
                <ul className="flex flex-col gap-2">
                  <li className="ms-[350px] font-medium">
                    Diversity & Inclusion
                  </li>
                  <li className="ms-[250px] font-medium">
                    Research Ethics & Integrity
                  </li>
                  <li className="ms-[200px] font-medium">
                    Faculty Research Development & Assessment
                  </li>
                  <li className="ms-[150px] font-medium">
                    Implement the Research Training Nexus
                  </li>
                  <li className="ms-[125px] font-medium">
                    Improve Scope & Development new PhD Programs
                  </li>
                  <li className="ms-[100px] font-medium">
                    Secure Funding (Internal & External)
                  </li>
                  <li className="ms-[75px] font-medium">
                    Build Collaborative Network (HEIs, industries)
                  </li>
                  <li className="ms-[50px] font-medium">
                    Establish Core Research Teams & Recruit Talent
                  </li>
                  <li className="ms-0 font-medium">
